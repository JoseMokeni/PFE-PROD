...
echo "🚀 Starting Traefik deployment for LeCoursier..."
...
echo "💾 Creating Traefik persistent volume..."
...
echo "⚙️ Applying Traefik middlewares..."
...
echo "🚀 Deploying LeCoursier application..."
...
echo ""
echo "🌐 Access URLs:"
echo "📊 Traefik Dashboard: http://localhost:8080 (or your-cluster-ip:8080)"
echo "🚀 Application: https://lecoursier.example.com (configure your domain)"
echo "📧 Mailhog: https://mailhog.example.com"
echo "🔴 Redis Commander: https://redis.example.com"
echo "🐘 pgAdmin: https://pgadmin.example.com"
